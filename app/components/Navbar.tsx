    ...
    return (
        <nav className=' w-full p-4 px-3 flex justify-around shadow shadow-amber-300 jakarta-sans'>
            ...
            <div className=" flex items-center">
                <Link href={'/'} className=' bg-linear-75 from-amber-400 to-amber-500 p-3 rounded-4xl text-neutral-50 font-semibold duration-500 
                hover:shadow-xl hover:shadow-amber-100 hover:text-neutral-800'>
