        ...
        <main className=' flex justify-center items-center font-sans bg-neutral-50 pb-8 pt-8' style={{ paddingTop: "24dvh" }}>
            <section className=" flex flex-col gap-8 items-center">
                ...
                <section data-aos="fade-up" data-aos-delay={10}>
                    <div className="border border-amber-400 p-2 rounded-4xl flex mt-8 mx-auto justify-between w-fit lg:w-[48dvw]">
                    ...
                    <div className=" flex gap-8 justify-center items-center font-sans mt-2 text-xs lg:text-base w-[80dvw]">
                        <div className=" flex gap-2 items-center justify-center">
                            ...
                            <p className='text-neutral-400 drop-shadow text-xs lg:text-base'>5 Jurusan</p>
                        </div>
                        <div className=" flex gap-2 items-center justify-center">
                            <i className="bi bi-circle-fill me-4 text-amber-400 drop-shadow drop-shadow-amber-400"></i>
                            <p className='text-neutral-400 drop-shadow text-xs lg:text-base'>30 Soal Assesment</p>
                        </div>
