...
const Hero = () => {
    ...
    return (
        <main className=' flex justify-center items-center font-sans bg-neutral-50 pb-8 pt-8'>
            <section className=" flex flex-col gap-8 items-center">
                <div className=" p-3 px-4 bg-amber-50 w-fit rounded-4xl flex gap-4 border text-amber-600 border-amber-400 shadow cursor-pointer duration-500 hover:shadow-xl hover:shadow-amber-100">
                ...
                <div className="border border-amber-400 p-2 rounded-4xl flex mt-8">
                    ...
                    <Link href={'/questions'} className=' bg-linear-270 from-amber-300 to-amber-400 p-3 px-5 text-neutral-100 rounded-3xl text-xl duration-500
                    hover:shadow-xl hover:shadow-amber-100' onClick={()=>handleSubmit()}>
                        <span>Mulai Tes</span>
